const Face = ({ scale = 1, eyeY = 0, mouth = "smile" }) => (
  <g transform={`scale(${scale})`}>
    <path
      d="M50 20 C20 20 4 42 4 70 C4 96 24 116 50 116 C76 116 96 96 96 70 C96 42 80 20 50 20 Z"
      fill="#F08A2E"
    />
    <ellipse cx="50" cy="80" rx="22" ry="20" fill="#FFE4BC" />
    <path
      d="M22 70 C18 88 28 102 50 102 C72 102 82 88 78 70 C70 56 30 56 22 70 Z"
      fill="#FFE4BC"
    />
    ...
    <path
      d="M16 28 C24 14 76 14 84 28 L86 36 C70 28 30 28 14 36 Z"
      fill="#3D4A8E"
    />
    ...
    {mouth === "open" && (
      <path d="M44 84 Q50 94 56 84 Q50 90 44 84 Z" fill="#7A2A2A" />
    )}
    {mouth === "smirk" && (
      <path
        d="M44 86 Q50 89 58 84"
        stroke="#241410"
        strokeWidth="2"
        fill="none"
        strokeLinecap="round"
    ...
    case "headphones":
      return (
        <svg width={size} height={size} viewBox="0 0 120 120" style={wrap}>
          <Face />
          <path
            d="M14 50 C14 30 36 14 60 14 C84 14 106 30 106 50"
            stroke="#3D4A8E"
            strokeWidth="6"
            fill="none"
          />
