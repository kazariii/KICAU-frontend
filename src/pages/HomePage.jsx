    ...
    <div className="page" style={{ paddingTop: 24 }}>
      ...
      <div
        style={{
          position: "relative",
          overflow: "hidden",
          background: "linear-gradient(135deg, #FFF1DA 0%, #FFE0B0 100%)",
      ...
      >
        ...
        >
          ...
          <div style={{ flex: 1, minWidth: 240 }}>
            ...
            <h1 style={{ fontSize: 44, lineHeight: 1.05, marginTop: 6 }}>
              Halo,{" "}
              <span style={{ color: "var(--brand-500)" }}>{user?.name}!</span>
            </h1>
            <p
              style={{
                marginTop: 10,
      ...
      >
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 24 }}>
          ...
          >
            ...
            <h2 style={{ fontSize: 26 }}>
              Yuk Buat{" "}
              <span style={{ color: "var(--brand-500)" }}>Ceritamu!</span>
            </h2>
            <p
              style={{ marginTop: 6, color: "var(--ink-500)", fontWeight: 600 }}
            >
                ...
                {themes.map((t) => (
                  <button
                    ...
                    style={{
                      ...
                      background: t.bg,
                      borderColor:
                        theme === t.id ? "var(--brand-500)" : t.border,
                      transform: theme === t.id ? "translateY(-3px)" : "none",
                      boxShadow:
                        theme === t.id
                          ? "0 8px 0 var(--brand-700), var(--shadow-md)"
                          : `0 4px 0 ${t.border}`,
                    }}
                  >
                    <div
            ...
            <div style={{ marginTop: 22 }}>
              ...
              >
                {morals.map((m) => (
                  <button
                    key={m.id}
                    onClick={() => setMoral(moral === m.id ? null : m.id)}
                    style={{
                      border: "2px solid",
                      borderRadius: 999,
                      ...
                      background: m.bg,
                      borderColor:
                        moral === m.id ? "var(--brand-500)" : "transparent",
                      transform: moral === m.id ? "scale(1.04)" : "none",
                    }}
                  >
                    <span
                      style={{
                ...
                {["pendek", "sedang", "panjang"].map((l) => (
                  <button
                    ...
                    style={{
                      ...
                      fontWeight: 800,
                      fontSize: 13,
                      background: length === l ? "white" : "transparent",
                      color:
                        length === l ? "var(--brand-700)" : "var(--ink-500)",
                      boxShadow: length === l ? "var(--shadow-sm)" : "none",
          ...
          >
            ...
            >
              <Icon name="target" size={28} color="var(--brand-500)" />
            </div>
            <div style={{ flex: 1 }}>
              <div
                style={{
              ...
              >
                <div
                  style={{
                    width: `${dailyChallenge.progress * 100}%`,
                    height: "100%",
                    background:
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 20 }}>
          <div
            ...
            style={{
              padding: 22,
              background: "linear-gradient(160deg, #2A140A, #4D2613)",
              color: "white",
              overflow: "hidden",
              position: "relative",
            }}
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
              {recents.map((r, i) => (
                ...
                >
                  ...
                  >
                    <Icon name="book" size={22} color="var(--ink-700)" />
                  </div>
          ...
          <div
            ...
            style={{
              padding: 22,
              background: "linear-gradient(160deg, #FFF, #FFF7E6)",
              display: "flex",
              alignItems: "center",
              gap: 14,
            }}
