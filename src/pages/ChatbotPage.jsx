      ...
      <div style={{ maxWidth: "78%" }}>
        <div
          ...
          style={
            isUser
              ? {
                  background: "linear-gradient(120deg, #4D2613, #2A140A)",
                  color: "white",
                  padding: "12px 16px",
              ...
              : {
                  background: "linear-gradient(120deg, #FBA01F, #F08A2E)",
                  color: "white",
                  padding: "12px 16px",
      ...
      >
        ...
        <div
          style={{
            ...
            background: "linear-gradient(135deg, #FFE4BC, #FFD09F)",
        ...
        >
          ...
          >
            ...
            <div
              ...
              style={{
                padding: 20,
                background: "linear-gradient(160deg, #FFF1DA, #FFE0B0)",
              }}
            >
              <div
                style={{
